...
export function useCreateTeacher(classId: string) {
  ...
  return useMutation({
    ...
    onSuccess: () =>
      void queryClient.invalidateQueries({ queryKey: classroomQueryKeys.teachers(classId) }),
  });
}
...
export function useCreateTeacherInvitation(classId: string) {
  const service = useClassroomService();
  return useMutation({
    mutationFn: (classTeacherId: string) =>
      service.createTeacherInvitation(classId, classTeacherId),
  });
}
...
export function useCreateScoreRule(classId: string) {
  ...
  return useMutation({
    ...
    onSuccess: () =>
      void queryClient.invalidateQueries({ queryKey: ['classrooms', classId, 'score-rules'] }),
  });
}
...
export function useCreateScoreEvent(classId: string) {
  ...
  return useMutation({
    ...
    onSuccess: () => {
      ...
      void queryClient.invalidateQueries({
        queryKey: ['classrooms', classId, 'score-periods', 'summary'],
      });
    },
  });
}
...
export function useUpdateCommittee(classId: string) {
  ...
  return useMutation({
    ...
    onSuccess: () =>
      void queryClient.invalidateQueries({ queryKey: classroomQueryKeys.committee(classId) }),
  });
}
...
export function useSaveSeatLayout(classId: string) {
  ...
  return useMutation({
    ...
    onSuccess: () => {
      void queryClient.invalidateQueries({ queryKey: classroomQueryKeys.seatLayout(classId) });
      void queryClient.invalidateQueries({
        queryKey: classroomQueryKeys.seatLayoutVersions(classId),
      });
    },
  });
}
...
export function useRandomPick(classId: string) {
  const service = useClassroomService();
  return useMutation({
    mutationFn: (excludeStudentIds: string[] = []) =>
      service.randomPick(classId, { excludeStudentIds }),
  });
}
...
export function useBindDisplayDevice(classId: string) {
  ...
  return useMutation({
    ...
    onSuccess: () =>
      void queryClient.invalidateQueries({ queryKey: classroomQueryKeys.displayDevices(classId) }),
  });
}
...
export function useExchangeDeviceCredential() {
  const service = useClassroomService();
  return useMutation({
    mutationFn: (input: DeviceTokenInput) => service.exchangeDeviceCredential(input),
  });
}
